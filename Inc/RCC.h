...
//PWR Registers
#define PWR_CR        (*( ( volatile unsigned int * ) (PWR_BASE + 0x00UL)  ) )

//RCC
#define RCC_BASE      0x40023800UL
//RCC Registers
#define RCC_CR        (*( ( volatile unsigned int * ) (RCC_BASE + 0x00UL)  ) )
#define RCC_PLLCFGR   (*( ( volatile unsigned int * ) (RCC_BASE + 0x04UL) ) )
#define RCC_CFGR      (*( ( volatile unsigned int * ) (RCC_BASE + 0x08UL)  ) )
#define RCC_CIR       (*( ( volatile unsigned int * ) (RCC_BASE + 0x0CUL)  ) )
#define RCC_AHB1ENR   (*( ( volatile unsigned int * ) (RCC_BASE + 0x30UL)  ) )
#define RCC_APB1ENR   (*( ( volatile unsigned int * ) (RCC_BASE + 0x40UL)  ) )
#define RCC_APB2ENR   (*( ( volatile unsigned int * ) (RCC_BASE + 0x44UL)  ) )
#define RCC_CSR       (*( ( volatile unsigned int * ) (RCC_BASE + 0x74UL)  ) )
