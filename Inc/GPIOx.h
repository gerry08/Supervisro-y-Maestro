...
typedef struct
{
  ...
  volatile uint32_t AFRL;   /*!< GPIO alternate function registers,     Address offset: 0x20-0x24 */
...
#define TIM1_AFR_AF1                     (1U) //AF=1
#define TIM2_AFR_AF1                     (1U) //AF=1

#define TIM3_AFR_AF2                     (2U) //AF=2
#define TIM4_AFR_AF2                     (2U) //AF=2
#define TIM5_AFR_AF2                     (2U) //AF=2

#define TIM8_AFR_AF3                     (3U) //AF=3
#define TIM9_AFR_AF3                     (3U) //AF=3
#define TIM10_AFR_AF3                    (3U) //AF=3
#define TIM11_AFR_AF3                    (3U) //AF=3

#define TIM12_AFR_AF3                    (9U) //AF=9
#define TIM13_AFR_AF3                    (9U) //AF=9
#define TIM14_AFR_AF3                    (9U) //AF=9

#define GPIO_AFR_AFSEL_UART1             (7UL)
#define GPIO_AFR_AFSEL_UART2             (7UL)
#define GPIO_AFR_AFSEL_UART4             (8UL)
#define GPIO_AFR_AFSEL_UART3             (7UL)
#define GPIO_AFR_AFSEL_UART6             (8UL)
